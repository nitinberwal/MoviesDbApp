...
fun PopularMoviesScreen(
    ...
    if(moviesListState.popularMoviesList.isEmpty()){
        ...
        LazyColumn(
            ...
            items(moviesListState.popularMoviesList.size) { index ->
                MovieItemUI(
                    moviesListState.popularMoviesList[index],
                    navHostController,
                    moviesViewModel,
                ...
                if(index >= moviesListState.popularMoviesList.size -1 && moviesListState.isLoading.not()){
